...
reagentsStateRouter.post('/', sanitizeReagentInput, escapeReagentInput, createReagent);
reagentsStateRouter.put('/:casNumber', sanitizeReagentInput, escapeReagentInput, updateReagent);
