...
export const sanitizeReagentInput = (req, res, next) => {
  const fieldsToSanitize = ["casNumber", "reagentName", "description", "classe", "brand", "classification", "local", "volume", "weight", "molecularFormula", "molecularWeight_g_per_mol", "furtherInformations"];
