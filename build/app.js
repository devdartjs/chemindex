...
const staticPath = NODE_ENV === "production" ? path.resolve(__dirname, "dist", "public") : path.resolve(__dirname, "public");
...
const reagentValidation = validate({
  body: reagentSchemaCreateValidator
});
...
app.listen(PORT, () => {
  console.log(`✅ Server running at port ${PORT} and ${NODE_ENV} mode on: http://localhost:${PORT}`);
});
export default app;